...
public class Payload extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 601102566757661148L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Payload\",\"namespace\":\"com.example.demo.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"payload\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"default\":null}]}");
   ...
   */
  public Payload(java.lang.Integer id, java.lang.String payload) {
    this.id = id;
   ...
   */
  public static com.example.demo.avro.Payload.Builder newBuilder() {
    return new com.example.demo.avro.Payload.Builder();
  }
   ...
   * @return A new Payload RecordBuilder
   */
  public static com.example.demo.avro.Payload.Builder newBuilder(com.example.demo.avro.Payload.Builder other) {
    if (other == null) {
      return new com.example.demo.avro.Payload.Builder();
    } else {
      return new com.example.demo.avro.Payload.Builder(other);
    }
  }
   ...
   * @return A new Payload RecordBuilder
   */
  public static com.example.demo.avro.Payload.Builder newBuilder(com.example.demo.avro.Payload other) {
    if (other == null) {
      return new com.example.demo.avro.Payload.Builder();
    } else {
      return new com.example.demo.avro.Payload.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Payload>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.demo.avro.Payload.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.demo.avro.Payload other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.avro.Payload.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.avro.Payload.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.avro.Payload.Builder setPayload(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.avro.Payload.Builder clearPayload() {
      payload = null;
